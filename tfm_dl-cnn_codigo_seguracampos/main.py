...
def main():
    ...
    #experiments.alexnet_model_no_transform(EPOCH_COUNT, ALEX_BATCH_SIZE, SEED, SMALLEST_LR)

    # Empty CUDA memory
    #torch.cuda.empty_cache()

    # Execution of the experiment for AlexNet Model with flip augmentation transformations
    experiments.alexnet_model_flip_transform(EPOCH_COUNT, ALEX_BATCH_SIZE, SEED, SMALLEST_LR)
